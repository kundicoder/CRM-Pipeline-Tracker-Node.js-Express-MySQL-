...
module.exports = {
    ...
    home: async (req, res) => {
          ...
          try {
                renderWithLayoutAndPartial(req, res, 'layouts/userLayout', 'partials/user/home', {}, 'userContents'); //without data
    ...
    homeIndex: async (req, res) => {
          ...
          try {
                 renderWithLayout(req, res, 'layouts/userLayout', 'partials/user/home', {}, 'userContents'); //without data
